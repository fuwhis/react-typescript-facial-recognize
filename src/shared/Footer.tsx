        ...
        <footer className="absolute w-full bg-white sm:p-6 dark:bg-gray-900 inset-x-0 border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 mt-[2rem]">
            <div className="lg:flex w-full mx-auto">
                ...
                <div className="w-full flex justify-center items-end">
                    <span className="bottom-0 text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">By Fuwhis</a>. All Rights Reserved.</span>

                    {/* Social Networking Links */}
                    {/* <div className="flex w-full mt-4 space-x-6 sm:justify-center sm:mt-0">
